...
import logging
import string
from saml_core.idp.xml_signing import get_signature_xml
from saml_core.idp.xml_templates import ATTRIBUTE, ATTRIBUTE_STATEMENT, ASSERTION_CYBOZU, RESPONSE, SUBJECT
...
def get_assertion_xml(parameters, signed=False):
    return _get_assertion_xml(ASSERTION_CYBOZU, parameters, signed)
